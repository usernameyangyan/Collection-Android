...
import com.youngmanster.collectionlibrary.base.helper.debug.DebugStackDelegate;
...
public class SupportActivityDelegate {
    ...
    public SupportActivityDelegate(BaseSupportActivity support) {
    ...
    public void setFragmentAnimator(FragmentAnimator fragmentAnimator) {
        ...
        for (Fragment fragment : FragmentationMagician.getActiveFragments(getSupportFragmentManager())) {
            if (fragment instanceof BaseSupportFragment) {
                BaseSupportFragment iF = (BaseSupportFragment) fragment;
    ...
    public void onBackPressed() {
        mTransactionDelegate.mActionQueue.enqueue(new Action(Action.ACTION_BACK) {
            ...
            public void run() {
                ...
                BaseSupportFragment activeFragment = SupportHelper.getActiveFragment(getSupportFragmentManager());
    ...
    public void startForResult(BaseSupportFragment toFragment, int requestCode) {
        mTransactionDelegate.dispatchStartTransaction(getSupportFragmentManager(), getTopFragment(), toFragment, requestCode, BaseSupportFragment.STANDARD, TransactionDelegate.TYPE_ADD_RESULT);
    }
    ...
    public void replaceFragment(BaseSupportFragment toFragment, boolean addToBackStack) {
        mTransactionDelegate.dispatchStartTransaction(getSupportFragmentManager(), getTopFragment(), toFragment, 0, BaseSupportFragment.STANDARD, addToBackStack ? TransactionDelegate.TYPE_REPLACE : TransactionDelegate.TYPE_REPLACE_DONT_BACK);
    }
